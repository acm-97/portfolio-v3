  ...
  const columns: ColumnsProps[] = [
    {
      ...
      cellProps: { className: 'border-transparent sec-color font--mono text-lg' },
      headerCellProps: { className: 'border-transparent text-xl  normal-case bg-transparent' },
    },
    {
      headerName: 'Title',
      accessor: 'name',
      cellProps: { className: 'border-transparent whitespace-normal primary-color' },
      headerCellProps: { className: 'border-transparent text-xl  normal-case bg-transparent' },
    },
    {
      headerName: 'Made at',
      accessor: ({ madeAt }: ProjectsProps) => madeAt || '--',
      cellProps: { className: 'max-md:hidden border-transparent primary-color text-base' },
      headerCellProps: { className: 'max-md:hidden border-transparent text-xl  normal-case bg-transparent' },
    },
    {
      headerName: 'Build with',
      cellProps: { className: 'max-md:hidden border-transparent whitespace-normal font--mono text-xs' },
      headerCellProps: { className: 'max-md:hidden border-transparent text-xl  normal-case bg-transparent' },
    ...
    {
      headerName: 'Links',
      cellProps: { className: 'border-transparent' },
      headerCellProps: { className: 'border-transparent text-xl  normal-case bg-transparent' },
