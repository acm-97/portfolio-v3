    ...
    <>
      ...
      <RevealList component="ul" className="w-full">
        {personalProjects.map(project => (
          ...
          >
            {/* project-content */}
            <div className="relative z-[5] w-full [grid-area:1_/_1_/_-1_/_7] group-[:nth-of-type(2n+1)]:text-right group-[:nth-of-type(2n+1)]:[grid-column:7_/_-1] max-lg:[grid-column:1_/_9] max-lg:group-[:nth-of-type(2n+1)]:[grid-column:5_/_-1] max-md:flex max-md:h-full max-md:flex-col max-md:justify-center max-md:p-[2.5rem_2.5rem_1.875rem] max-md:[grid-column:1_/_-1] max-md:group-[:nth-of-type(2n+1)]:text-left max-sm:p-[1.875rem_1.5625rem_1.25rem]  ">
              {/* project-header */}
              <div className="ml-2 group-[:nth-of-type(2n+1)]:mr-2">
              ...
              {/* project-keywords */}
              <div className="mb-3 flex flex-wrap justify-start text-sm text-primary-dark group-[:nth-of-type(2n+1)]:justify-end max-md:!justify-start">
            ...
            <div className="relative z-[1] transition-[all_0.25s_cubic-bezier(0.645,0.045,0.355,1)] [grid-area:1_/_6_/_-1_/_-1] hover:z-10 group-[:nth-of-type(2n+1)]:[grid-column:1_/_8] max-md:h-full max-md:opacity-25 max-md:[grid-column:1_/_-1]">
